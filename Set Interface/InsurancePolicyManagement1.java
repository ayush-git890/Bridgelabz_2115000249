...
public class InsurancePolicyManagement1{
    private Set<InsurancePolicy> hs1 = new HashSet<>();
    private Set<InsurancePolicy> hs2 = new LinkedHashSet<>();
    private Set<InsurancePolicy> hs3 = new TreeSet<>();
    ...
    public void displayExpiringSoon() {
        ...
        for (InsurancePolicy policy : hs3) {
    ...
    public void displayByCoverageType(String coverageType) {
        ...
        for (InsurancePolicy policy : hs1) {
    ...
    public static void main(String[] args) {
        ...
        system.addPolicy(new InsurancePolicy("1111", "rohit", date1, "Health", 1200));
        system.addPolicy(new InsurancePolicy("2222", "mohit", date2, "Auto", 900));
